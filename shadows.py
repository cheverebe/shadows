...
from path_finder import find_path, get_roi_corners, get_roi
...
def listener(angle=None):
    ...
    edged_w_roi = cv2.rectangle(edged, (roi_corners[2],roi_corners[0]), (roi_corners[3],roi_corners[1]), (0,255,0))
